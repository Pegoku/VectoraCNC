 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 12.5, 12.5, 2.5 }
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Z  // CNC: allow Z below machine home for touch-off / work zero
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 193       // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 172       // (mm) Y point for Z homing
  //#define Z_SAFE_HOMING_POINT_ABSOLUTE  // Ignore home offsets (M206) for Z homing position
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (8*60), (8*60), (4*60) }
