 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME   600       // (mA) RMS current for homing. Lower helps sensorless homing reliability.
...
//#define LASER_FEATURE
  ...
  #define FAN0_PIN                      -1
    ...
    #define SPINDLE_LASER_PWM_MAX       106    // 10V equivalent from a 24V PWM rail: round(10/24*255)=106
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
     ...
     */
      ...
      #define SPEED_POWER_MIN             0    // (RPM) Allow true 0% PWM at low S values
      #define SPEED_POWER_MAX         12000    // (RPM) Spindle maximum speed
      #define SPEED_POWER_STARTUP     10000    // (RPM) M3/M4 speed/power default (with no arguments)
